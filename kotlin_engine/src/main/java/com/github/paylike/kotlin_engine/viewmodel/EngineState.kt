...
/**
 * [WAITING_FOR_INPUT]
 * - initial state [WEBVIEW_CHALLENGE_STARTED]
 * - the first html response has arrived [WEBVIEW_CHALLENGE_USER_INPUT_REQUIRED]
 * - the html form is rendered [SUCCESS]
 * - successful TDS flow [ERROR]
